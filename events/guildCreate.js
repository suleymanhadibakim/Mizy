...
client.on('guildCreate', guild => {
	...
	client.user.setGame(prefix + '!!yardım **YENİ KOMUT** !!espriyap !!zekam| ' + client.guilds.size + ' sunucu | ' + client.guilds.reduce((a, b) => a + b.memberCount, 0).toLocaleString() + ' kullanıcı');
})
